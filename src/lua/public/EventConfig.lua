...
EV_DATING_EVENT = {
    ...
    exitScriptView = "exitScriptView",            --退出约会界面
...
EV_ACTIVITY_SUMMON_EQUIP_REWARD = "EV_ACTIVITY_SUMMON_EQUIP_REWARD"   --质点活动抽取
...
EV_FUNC_GET_MOON_AWARD          = "EV_FUNC_GET_MOON_AWARD"     --领取制作月饼奖励
...
EV_UNION_GET_ITEM_WEEK_GAINED     = "EV_UNION_GET_ITEM_WEEK_GAINED"    --社团任务代币获得
...
EV_WORLD_ROOM_SETTING_CHANGE = "EV_WORLD_ROOM_SETTING_CHANGE" 
EV_WORLD_ROOM_ACTOR_DATA = "EV_WORLD_ROOM_ACTOR_DATA"              --交易结果返回
...
EV_WORLD_FAIR_RESULT  = "EV_WORLD_FAIR_RESULT"
EV_WORLD_SKILL_CHANGE  = "EV_WORLD_SKILL_CHANGE"
EV_WORLD_FIGHT_READY_FAIL = "EV_WORLD_FIGHT_READY_FAIL"
EV_WORLD_OPEN_COLLECT_BOX = "EV_WORLD_OPEN_COLLECT_BOX"
...
-- 信息收集
EV_UPDATE_CHANGE_ADDRESS_IG = "EV_UPDATE_CHANGE_ADDRESS_IG"   --信息收集地址更改

-- 祭月消息回来
EV_UPDATE_FULLSERVER_PROGRESS = "EV_UPDATE_FULLSERVER_PROGRESS" -- 祭月全服进度及个人进度及已领取的进度


--中华街
EV_UPDATE_CHINESE_STREET = "EV_UPDATE_CHINESE_STREET"   --更新中华街建筑等级信息
EV_UPDATE_CHINESE_STREET_SOLICIT = "EV_UPDATE_CHINESE_STREET_SOLICIT"   --更新中华街揽客数据信息
EV_UPDATE_CHINESE_GUESS_REWARD = "EV_UPDATE_CHINESE_GUESS_REWARD"   --猜谜奖励通知

--怕痛
EV_TONG = {
    BaseInfo    = "BaseInfo",                           --怕痛基础信息
    EliteInfo   = "EliteInfo",                          --精英关卡信息
    HelpInfo    = "HelpInfo",                           --帮助信息
    Retreat     = "Retreat",                            --撤退
    BattleCnt   = "BattleCnt",                          --挑战次数
    WorldBoss   = "WorldBoss",                          --世界boss
    ActiveAffix = "ActiveAffix",                        --操作buff
    AfterEquip  = "AfterEquip",                         --装备技能buff后
    SaveAttr    = "SaveAttr",                           --存储属性
    ResetStudy  = "ResetStudy",                         --重置学习
    Report      = "Report",                             --战报
    UpdateAir   = "UpdateAir",                          --刷新空投
    UpdateElite = "UpdateElite",                        --刷新精英关卡
    UnLockSkill = "UnLockSkill",                        --技能解锁提示
    RankInfo    = "RankInfo",                           --排行榜信息
    BossAward   = "BossAward",                          --世界boss阶段奖励
    FinishElite = "FinishElite",                        --结束精英关卡
    UpdateSkill = "UpdateSkill",                        --刷新技能
    UpdateHelpBuff = "UpdateHelpBuff",                  --刷新帮助buff
    MonsterTimeOut  = "MonsterTimeOut",                 --精英时间到了
}

EV_ACTIVITY_HUADENG_LEVEL_CHANGE = "EV_ACTIVITY_HUADENG_LEVEL_CHANGE"