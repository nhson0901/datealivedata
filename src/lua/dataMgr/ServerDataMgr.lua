...
function ServerDataMgr:getCurrentServerIndex()
    ...
    self.currentServerIndex = self.currentServerIndex or 1
...
function ServerDataMgr:getServerRoleToken( idx )
    if self.gameSeverList == nil then return "xxxxxxxxxxxxxxxxxxxx" end
    if #self.gameSeverList < 1 then return "xxxxxxxxxxxxxxxxxxxx" end
    if idx > #self.gameSeverList then
        idx = #self.gameSeverList
    end
    return self.gameSeverList[idx].token
end
