local QLBirthdayGiveView = class("QLBirthdayGiveView", BaseLayer)
function QLBirthdayGiveView:ctor(...)
...
function QLBirthdayGiveView:initData(commodityId)
...
function QLBirthdayGiveView:caculateMaxBuyCount()
    self.maxBuyCount = self.itemCount_
end

function QLBirthdayGiveView:initUI(ui)
    ...
    self.Label_use  = TFDirector:getChildByPath(Image_bg, "Label_use")

    self.Label_use:setTextById(490304)
    ...
    self.Label_cost_cn = TFDirector:getChildByPath(Image_bg,"Label_cost_cn"):hide()
    self.Label_cost_num = TFDirector:getChildByPath(Image_bg,"Label_cost_num")

    self:refreshView()
end

function QLBirthdayGiveView:refreshView()
...
function QLBirthdayGiveView:onClose()
...
function QLBirthdayGiveView:registerEvents()
    ...
    self.Button_buy:onClick(function()
        ...
        ActivityDataMgr2:Send_QLBirthdayNum(self.selectNum)
...
function QLBirthdayGiveView:continueAddAction(addOrReduce)
    local delayTime = 0
    local neddTime  = 0.5
...
function QLBirthdayGiveView:continueReduceAction(addOrReduce)
    local delayTime = 0
    local neddTime  = 0.5
    local function action(dt)
        delayTime = delayTime + dt
...
function QLBirthdayGiveView:onTouchButtonDown()
    self:updateBatchPanel(-1)
end

function QLBirthdayGiveView:onTouchButtonUp()
    self:updateBatchPanel(1)
end

function QLBirthdayGiveView:updateBatchPanel(num)
    ...
    self.Label_cost_num:setText("")
end

return QLBirthdayGiveView
