...
--[[
	[1] = {--ResSkillInfo
		[1] = {--repeated AttrDistribute
			[1] = 'int32':attr	[属性]
			[2] = 'int32':point	[点数]
		},
		[2] = 'repeated int32':unlockSkill	[已解锁的技能]
		[3] = {--repeated EquipSkill
			[1] = 'int32':pos	[位置]
			[2] = 'int32':skillId	[技能id]
		},
	}
--]]
s2c.FEAR_PAIN_RES_SKILL_INFO = 9516
...
--[[
	[1] = {--ResRefreshElite
		[1] = {--PassInfo
			[1] = 'int32':cid	[位置,对应map的id]
			[2] = 'int32':mgrId	[配置id,对应于DungeonMgr表]
			[3] = 'int32':endTime	[截止时间,时间戳,秒]
		},
		[2] = {--ChangeType(enum)
			'v4':ChangeType
		},
...
--]]
s2c.FEAR_PAIN_RES_REFRESH_ELITE = 9521
...
--]]
s2c.FEAR_PAIN_RES_ELITE_RETREAT = 9503
...
--[[
	[1] = {--ResWorldBoss
		...
		[3] = 'int32':myHurt	[我的]
		[4] = 'int32':threat	[威胁值]
		[5] = 'repeated int32':finishedReward	[领过的奖]
		[6] = 'int32':stageId	[stageId]
	}
--]]
s2c.FEAR_PAIN_RES_WORLD_BOSS = 9509
...
--]]
s2c.FEAR_PAIN_RES_RESET_ATTR = 9520
...
--]]
s2c.ACTIVITY2_RESP_LUNCKY_AWARD = 9419
...
--]]
s2c.FEAR_PAIN_RES_DISTRIBUTE = 9517
...
--]]
s2c.ACTIVITY2_RESP_EXCHANGE_TASK = 9420
...
--[[
	[1] = {--ResHelpInfo
		[1] = 'int32':leftHelp	[剩余支援点数]
		[2] = {--repeated EliteHelp
			[1] = 'string':uid	[某条支援的uid]
			[2] = 'int32':id	[关卡id]
			[3] = 'int32':playerId	[发出请求的玩家]
			[4] = 'string':name	[发出请求的玩家]
			[5] = 'int32':headFrame	[头像框]
			[6] = 'int32':headId	[头像]
		},
	}
--]]
s2c.FEAR_PAIN_RES_HELP_INFO = 9506
...
--]]
s2c.FEAR_PAIN_UNLOCK_SKILL_NOTICE = 9519
...
--[[
	[1] = {--ResFightReport
		[1] = {--repeated FightReport
			[1] = 'string':name	[玩家名字]
			[2] = 'int32':hurt	[伤害]
		},
	}
--]]
s2c.FEAR_PAIN_RES_FIGHT_REPORT = 9510
...
--[[
	[1] = {--ResEliteInfo
		[1] = 'int32':id
		[2] = 'string':hp	[当前血量]
		[3] = 'int32':leftTime	[剩余时间,秒]
		[4] = 'repeated int32':affix	[词缀]
		[5] = 'repeated int32':fearlessAffix	[无畏模式选的词缀]
		[6] = 'int32':leftCount	[剩余挑战次数]
		[7] = 'int32':helpBuff	[援助buff,没有就不传]
		[8] = 'repeated int32':helpType	[1好友,2社团成员]
		[9] = 'bool':fearless	[是否无畏模式]
		[10] = {--EliteStatus(enum)
			'v4':EliteStatus
		},
		[11] = 'int32':buyIndex	[购买index,从0开始]
		[12] = {--repeated EliteRecord
			[1] = 'int32':type	[1战斗,2kill,3支援]
			[2] = 'int32':hurt	[伤害]
			[3] = 'string':helpPlayerName	[支援玩家昵称]
		},
		[13] = 'int32':threatId	[威胁id]
		[14] = 'int32':threat	[威胁值]
		[15] = 'bool':played	[是否播放了效果]
		[16] = 'int32':threatChange	[打完后展示威胁值变化]
		[17] = 'string':maxHp	[boss最大血量]
		[18] = 'bool':fearlessUnlock	[是否解锁了无畏模式]
	}
--]]
s2c.FEAR_PAIN_RES_ELITE_INFO = 9502
...
--[[
	[1] = {--RespGetDiamondExchangeItem
		[1] = 'int32':diamondNum	[钻石]
		[2] = 'int32':exchangeItemNum	[代币]
	}
--]]
s2c.RECHARGE_RESP_GET_DIAMOND_EXCHANGE_ITEM = 4389
...
--]]
s2c.FEAR_PAIN_RES_FINISH_ELITE = 9512
...
--[[
	[1] = {--ResRefreshAir
		...
		[2] = 'string':nextRefreshTime	[下次空投刷新时间,毫秒]
		[3] = 'int32':nextNum	[下次补给数量]
		[4] = {--ChangeType(enum)
			'v4':ChangeType
		},
	}
--]]
s2c.FEAR_PAIN_RES_REFRESH_AIR = 9508
...
--]]
s2c.FEAR_PAIN_RES_ELITE_HELP = 9504
...
--[[
	[1] = {--HelpBuffNotice
		[1] = 'int32':helpBuff	[援助buff]
		[2] = {--repeated EliteRecord
			[1] = 'int32':type	[1战斗,2kill,3支援]
			[2] = 'int32':hurt	[伤害]
			[3] = 'string':helpPlayerName	[支援玩家昵称]
		},
...
--]]
s2c.FEAR_PAIN_HELP_BUFF_NOTICE = 9522
...
--[[
	[1] = {--ResEquipSkill
		[1] = {--repeated EquipSkill
			[1] = 'int32':pos	[位置]
			[2] = 'int32':skillId	[技能id]
		},
	}
--]]
s2c.FEAR_PAIN_RES_EQUIP_SKILL = 9518
...
--[[
	[1] = {--ResFearPainFightInfo
		...
		[2] = 'string':nextRefreshTime	[下次空投刷新时间,毫秒]
		[3] = 'int32':nextNum	[下次补给数量]
		[4] = 'int32':threatId	[当前威胁id]
		[5] = 'int32':stageId	[stageId]
	}
--]]
s2c.FEAR_PAIN_RES_FEAR_PAIN_FIGHT_INFO = 9501
...
--]]
s2c.FEAR_PAIN_RES_TAKE_PROGRESS_REWARD = 9515
...
--[[
	[1] = {--ResBuyCount
		[1] = 'int32':leftCount	[剩余挑战次数]
		[2] = 'int32':buyIndex	[购买index,从0开始]
	}
--]]
s2c.FEAR_PAIN_RES_BUY_COUNT = 9507
...
--[[
	[1] = {--ResChooseAffix
		[1] = 'repeated int32':affix
	}
--]]
s2c.FEAR_PAIN_RES_CHOOSE_AFFIX = 9513
...
--[[
	[1] = {--ResFearPainRank
		[1] = 'int32':type	[1世界全程,2boss击杀,3无畏]
		[2] = {--repeated WorldBossRank
			[1] = 'int32':index	[排名]
			[2] = 'int32':headFrame	[头像框]
			[3] = 'int32':headId	[头像]
			[4] = 'string':name	[玩家名字]
			[5] = 'string':ratio	[击杀率]
			[6] = 'int32':count	[总战斗次数]
		...
		[3] = {--repeated FearlessRank
			[1] = 'int32':index	[排名]
			[2] = 'int32':headFrame	[头像框]
			[3] = 'int32':headId	[头像]
			[4] = 'string':name	[玩家名字]
			[5] = 'repeated int32':squads	[阵容]
			[6] = 'repeated int32':affix	[词缀]
			[7] = 'int32':time	[通关时长]
			[8] = 'int32':score	[评分]
		},
		[4] = 'int32':dungeonId	[无畏模式对应的id,无畏模式必传,不管显示与否]
		[5] = 'int32':flag	[客户端标记]
		[6] = 'int32':page	[页数]
		[7] = {--WorldBossRank
			[1] = 'int32':index	[排名]
		...
		[9] = 'bool':show	[是否显示,true显示,false不显示]
		[10] = 'bool':checking	[自己是否处于审查中,true是的]
	}
--]]
s2c.FEAR_PAIN_RES_FEAR_PAIN_RANK = 9511
...
--]]
s2c.FEAR_PAIN_RES_HELP_OTHER = 9505
...
--]]
s2c.FEAR_PAIN_RES_EFFECT_PLAYED = 9514
