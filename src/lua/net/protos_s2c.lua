local tblProto = {
	...
	[9516] = function()
		return {
			...
			{{true,{'attrDistribute','attr', 'point', }},'unlockSkill', {true,{'equipSkill','pos', 'skillId', }},}
		}
	end,
	[6665] = function()
		return {
	...
	[9521] = function()
		return {
			{"net.NetHelper", "receive"},
			{{false,{'v4', 'v4', 'v4', }},'v4',},
			{{false,{'passInfo','cid', 'mgrId', 'endTime', }},'changeType',}
		}
	end,
	[9006] = function()
		return {
	...
	[9509] = function()
		return {
			{"net.NetHelper", "receive"},
			{'s', {true,{'v4', 's', 'v4', }},'v4', 'v4', 'tv4', 'v4', },
			{'progress', {true,{'rank','index', 'name', 'hurt', }},'myHurt', 'threat', 'finishedReward', 'stageId', }
		}
	end,
	[8707] = function()
		return {
	...
	[9419] = function()
		return {
			{"net.NetHelper", "receive"},
			{'v4', 'v4', {true,{'v4', 'v4', }},},
			{'activityId', 'itemId', {true,{'rewards','id', 'num', }},}
		}
	end,
	[4386] = function()
		return {
	...
	[9517] = function()
		return {
			{"net.NetHelper", "receive"},
			{{true,{'v4', 'v4', }},},
			{{true,{'attrDistribute','attr', 'point', }},}
		}
	end,
	[8701] = function()
		return {
	...
	[9506] = function()
		return {
			{"net.NetHelper", "receive"},
			{'v4', {true,{'s', 'v4', 'v4', 's', 'v4', 'v4', }},},
			{'leftHelp', {true,{'Help','uid', 'id', 'playerId', 'name', 'headFrame', 'headId', }},}
		}
	end,
	[1795] = function()
		return {
	...
	[9502] = function()
		return {
			{"net.NetHelper", "receive"},
			{'v4', 's', 'v4', 'tv4', 'tv4', 'v4', 'v4', 'tv4', 'b', 'v4','v4', {true,{'v4', 'v4', 's', }},'v4', 'v4', 'b', 'v4', 's', 'b', },
			{'id', 'hp', 'leftTime', 'affix', 'fearlessAffix', 'leftCount', 'helpBuff', 'helpType', 'fearless', 'status','buyIndex', {true,{'eliteRecord','type', 'hurt', 'helpPlayerName', }},'threatId', 'threat', 'played', 'threatChange', 'maxHp', 'fearlessUnlock', }
		}
	end,
	[6656] = function()
		return {
	...
	[9508] = function()
		return {
			...
			{{true,{'passInfo','cid', 'mgrId', 'endTime', }},'nextRefreshTime', 'nextNum', 'changeType',}
		}
	end,
	[7003] = function()
		return {
	...
	[9522] = function()
		return {
			{"net.NetHelper", "receive"},
			{'v4', {true,{'v4', 'v4', 's', }},},
			{'helpBuff', {true,{'eliteRecord','type', 'hurt', 'helpPlayerName', }},}
		}
	end,
	[7703] = function()
		return {
	...
	[9501] = function()
		return {
			{"net.NetHelper", "receive"},
			{{true,{'v4', 'v4', 'v4', }},'s', 'v4', 'v4', 'v4', },
			{{true,{'passInfo','cid', 'mgrId', 'endTime', }},'nextRefreshTime', 'nextNum', 'threatId', 'stageId', }
		}
	end,
	[7802] = function()
		return {
	...
	[9511] = function()
		return {
			{"net.NetHelper", "receive"},
			{'v4', {true,{'v4', 'v4', 'v4', 's', 's', 'v4', 'v4', }},{true,{'v4', 'v4', 'v4', 's', 'tv4', 'tv4', 'v4', 'v4', }},'v4', 'v4', 'v4', {false,{'v4', 'v4', 'v4', 's', 's', 'v4', 'v4', }},{false,{'v4', 'v4', 'v4', 's', 'tv4', 'tv4', 'v4', 'v4', }},'b', 'b', },
			{'type', {true,{'worldBossRank','index', 'headFrame', 'headId', 'name', 'ratio', 'count', 'hurt', }},{true,{'fearlessRank','index', 'headFrame', 'headId', 'name', 'squads', 'affix', 'time', 'score', }},'dungeonId', 'flag', 'page', {false,{'myWorldBossRank','index', 'headFrame', 'headId', 'name', 'ratio', 'count', 'hurt', }},{false,{'myFearlessRank','index', 'headFrame', 'headId', 'name', 'squads', 'affix', 'time', 'score', }},'show', 'checking', }
		}
	end,
	[7207] = function()
		return {
	...
	[9505] = function()
		return {
			{"net.NetHelper", "receive"},
			{'v4', 's', {true,{'v4', 'v4', }},},
			{'leftHelp', 'uid', {true,{'reward','id', 'num', }},}
		}
	end,
	[5124] = function()
		return {
