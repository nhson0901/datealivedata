										...
										},
										{
											...
											components = 
											{
												...
												},
												{
													...
													sizeType = "0",
													srcBlendFunc = "770",
													text = "Use Fire Crackers to defeat at least one Nian Beast",
													touchAble = "False",
													touchScaleEnable = "False",
													UILayoutViewModel = 
													{
						...
						
						{
							...
							components = 
							{
								...
								},
								{
									...
									sizeType = "0",
									srcBlendFunc = "770",
									text = "Nian Beasts are immune to all damage including Entrance skills, Spirit Passive skills, etc. except Fire Cracker skill damage.",
									touchAble = "False",
									touchScaleEnable = "False",
									UILayoutViewModel = 
									{
